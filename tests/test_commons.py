"""Tests for storage/coverage.py — resolve_date_range."""
...
class TestResolveDateRange:
    ...
    def test_no_store_coverage_raises_value_error(self):
        with patch("h2mare.storage.coverage.get_store_coverage", return_value=None):
    ...
    def test_start_inferred_as_day_after_store_end(self):
        ...
        with patch("h2mare.storage.coverage.get_store_coverage", return_value=coverage):
    ...
    def test_end_inferred_as_today_when_not_provided(self):
        ...
        with (
            patch("h2mare.storage.coverage.get_store_coverage", return_value=coverage),
